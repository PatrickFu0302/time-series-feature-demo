...
@st.cache_data
def read_data():
    pca_matrix = pd.read_csv('https://github.com/PatrickFu0302/time-series-feature-demo/blob/main/pca_matrix.csv')
    tsne_matrix = pd.read_csv('https://github.com/PatrickFu0302/time-series-feature-demo/blob/main/tsne_matrix.csv')
